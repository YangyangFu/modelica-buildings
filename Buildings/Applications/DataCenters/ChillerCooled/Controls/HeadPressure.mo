...
equation
  ...
  connect(pmcMod.y, swi.u2) annotation (Line(points={{-59,0},{-2,0}},
                              color={255,0,255}));
  connect(conPID.y, swi.u1) annotation (Line(points={{-29,60},{-20,60},{-20,8},
          {-2,8}},color={0,0,127}));
  connect(uni.y, swi.u3) annotation (Line(points={{-39,-50},{-20,-50},{-20,-8},{
          -2,-8}}, color={0,0,127}));
  connect(swi.y, y) annotation (Line(points={{21,0},{110,0}}, color={0,0,127}));
...
to adjuste the condenser water flowrate in order to statisfy the minimum temperature.
</p>
</html>", revisions="<html>
<ul>
<li>
