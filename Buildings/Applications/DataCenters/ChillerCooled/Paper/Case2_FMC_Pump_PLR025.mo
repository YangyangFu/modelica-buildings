...
equation
 ...
 annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Paper/Case2_FMC_Pump_PLR025.mos"
        "Simulate and Plot"));
end Case2_FMC_Pump_PLR025;
