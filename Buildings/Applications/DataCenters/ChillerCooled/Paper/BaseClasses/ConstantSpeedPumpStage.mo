...
model ConstantSpeedPumpStage
  ...
  Modelica.StateGraph.Transition con4(
    enableTimer=true,
    waitTime=tWai,
    condition= not cooMod == Integer(Buildings.Applications.DataCenters.Types.CoolingModes.FreeCooling)
      and
      (not cooMod == Integer(Buildings.Applications.DataCenters.Types.CoolingModes.PartialMechanical))
      and
      (not cooMod == Integer(Buildings.Applications.DataCenters.Types.CoolingModes.FullMechanical)))
