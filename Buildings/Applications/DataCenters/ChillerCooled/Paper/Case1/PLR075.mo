...
model PLR075 "Part load ratio is 0.75"
  import Buildings;
...
equation
  ...
  connect(uni.y, filter.u) annotation (Line(points={{239,250},{234,250},{234,
          280},{-384,280},{-384,-218},{136,-218},{136,-160},{122,-160}}, color=
          {0,0,127}));
  connect(uni.y, pro1.u1) annotation (Line(points={{239,250},{232,250},{232,280},
          {-382,280},{-382,-132},{-92,-132}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Paper/Case1/PLR075.mos"
        "Simulate and Plot"));
end PLR075;
