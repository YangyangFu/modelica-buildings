...
model PLR050 "Part load ratio is 0.5"
  import Buildings;
...
equation
  ...
  connect(uni.y, filter.u) annotation (Line(points={{239,250},{232,250},{232,
          300},{-378,300},{-378,-216},{140,-216},{140,-160},{122,-160}}, color=
          {0,0,127}));
  connect(uni.y, pro1.u1) annotation (Line(points={{239,250},{232,250},{232,296},
          {-374,296},{-374,-132},{-92,-132}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Paper/Case1/PLR050.mos"
        "Simulate and Plot"));
end PLR050;
