...
model PLR025 "Part load ratio is 0.25"
  import Buildings;
...
equation
  ...
  connect(uni.y, filter.u) annotation (Line(points={{239,250},{232,250},{232,
          280},{-372,280},{-372,-216},{140,-216},{140,-160},{122,-160}}, color=
          {0,0,127}));
  connect(uni.y, pro1.u1) annotation (Line(points={{239,250},{230,250},{230,278},
          {-370,278},{-370,-132},{-92,-132}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Paper/Case1/PLR025.mos"
        "Simulate and Plot"));
end PLR025;
