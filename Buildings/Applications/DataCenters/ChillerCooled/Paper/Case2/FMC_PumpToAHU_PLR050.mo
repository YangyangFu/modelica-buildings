...
equation
  ...
  connect(uni.y, swi1.u3) annotation (Line(points={{259,248},{248,248},{248,202},
 ...
 annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Paper/Case2/FMC_PumpToAHU_PLR050.mos"
        "Simulate and Plot"));
end FMC_PumpToAHU_PLR050;
