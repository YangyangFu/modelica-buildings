within Buildings.Applications.DataCenters.ChillerCooled.Paper.Case3;
model PLR075SolarData
  ...
  Buildings.Utilities.Math.SmoothMax smoothMax(deltaX=1e-3)
...
equation
  ...
  connect(noPow.y, smoothMax.u2) annotation (Line(points={{401,-10},{410,-10},{410,
          34},{418,34}}, color={0,0,127}));
  connect(add2.y, smoothMax.u1) annotation (Line(points={{401,42},{410,42},{410,
          46},{418,46}}, color={0,0,127}));
  connect(smoothMax.y, batCon.powDis) annotation (Line(points={{441,40},{446,40},
  ...
  connect(DHI.y[1], weaData.HDifHor_in) annotation (Line(points={{-379,-50},{
          -370,-50},{-370,-77.6},{-361,-77.6}}, color={0,0,127}));
  connect(GHI.y[1], weaData.HGloHor_in) annotation (Line(points={{-379,-80},{
          -370,-80},{-370,-83},{-361,-83}}, color={0,0,127}));
