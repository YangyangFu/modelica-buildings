...
equation
  ...
  connect(gri.terminal, sen.terminal_n) annotation (Line(points={{310,180},{310,
          170},{260,170},{260,-40},{362,-40},{362,-56}}, color={0,120,120}));
  connect(sen.terminal_p, traACAC.terminal_n) annotation (Line(points={{362,-76},
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Paper/Case2/FC_AHU_PLR1.mos"
        "Simulate and Plot"));
end FC_AHU_PLR1;
