...
model FMC_AHU_PLR1
  ...
  Buildings.Utilities.Math.SmoothMin smoothMin(deltaX=1e-3)
...
equation
  ...
  connect(powAHU.y, criPow.u[1]) annotation (Line(points={{201,-40},{212,-40},{212,
          -16},{276,-16},{276,43.5},{298,43.5}},     color={0,0,127}));
  ...
  connect(zer.y, swi1.u1) annotation (Line(points={{239,210},{160,210},{160,
          -126},{200,-126},{200,-152},{184,-152}}, color={0,0,127}));
  connect(uni.y, swi1.u3) annotation (Line(points={{239,250},{248,250},{248,202},
  ...
  connect(noPow.y,smoothMin. u2) annotation (Line(points={{401,-10},{410,-10},{410,
          34},{418,34}}, color={0,0,127}));
  connect(pv.P, add2.u2) annotation (Line(points={{441,197},{452,197},{452,20},{
          368,20},{368,36},{378,36}}, color={0,0,127}));
  connect(smoothMin.y, batCon.powDis) annotation (Line(points={{441,40},{446,40},
          {446,154},{316,154},{316,142}}, color={0,0,127}));
  connect(add2.y,smoothMin. u1) annotation (Line(points={{401,42},{410,42},{410,
          46},{418,46}}, color={0,0,127}));
  ...
  connect(sen.terminal_n, traACAC.terminal_n) annotation (Line(points={{362,-80},
          {362,-88},{350,-88}}, color={0,120,120}));
  connect(sen.terminal_p, gri.terminal) annotation (Line(points={{362,-60},{362,
          -50},{260,-50},{260,170},{310,170},{310,180}}, color={0,120,120}));
  connect(powRack.y, criPow.u[2]) annotation (Line(points={{201,-68},{278,-68},{
          278,36.5},{298,36.5}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Paper/Case2/FMC_AHU_PLR1.mos"
        "Simulate and Plot"));
end FMC_AHU_PLR1;
