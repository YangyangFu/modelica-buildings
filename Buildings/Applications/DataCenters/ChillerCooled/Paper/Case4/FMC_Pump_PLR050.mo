...
model FMC_Pump_PLR050
  ...
  Buildings.Applications.DataCenters.ChillerCooled.Paper.BaseClasses.BatteryControl
    batCon(SOCLow=0.01, SOCHig=0.99) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={310,130})));
  Buildings.Controls.OBC.CDL.Continuous.MultiSum criPow(nin=6) "Critical power"
...
equation
  ...
  connect(powAHU.y, criPow.u[1]) annotation (Line(points={{201,-40},{212,-40},{
          212,-16},{276,-16},{276,45.8333},{298,45.8333}},
                                                     color={0,0,127}));
  connect(powIT.y, criPow.u[2]) annotation (Line(points={{201,-88},{212,-88},{
          212,-58},{278,-58},{278,43.5},{298,43.5}}, color={0,0,127}));
  ...
  connect(powRack.y, criPow.u[6]) annotation (Line(points={{201,-68},{280,-68},
          {280,34.1667},{298,34.1667}}, color={0,0,127}));
