...
block SpecificHeatCapacityEquivalentFluid
  ...
  h_TWetBul h1(use_p_in=false)
    "Specific enthalpy pf equivalent fluid at inlet "
    annotation (Placement(transformation(extent={{-80,40},{-60,60}})));
  h_TWetBul h2(use_p_in=false)
    "Specific enthalpy of equvilaent fluid at outlet"
    annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));
  Controls.OBC.CDL.Continuous.Add add1(final k1=1, final k2=-1) "Addition 1"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  Controls.OBC.CDL.Continuous.Add add2(final k1=1, final k2=-1) "Addition 1"
    annotation (Placement(transformation(extent={{-20,-40},{0,-20}})));
  Controls.OBC.CDL.Continuous.Division div
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  Controls.OBC.CDL.Interfaces.RealOutput cpe(
...
equation
  ...
  connect(T2, h2.TWetBul)
    annotation (Line(points={{-120,-50},{-82,-50}}, color={0,0,127}));
  connect(h2.h, add1.u2) annotation (Line(points={{-59,-50},{-50,-50},{-50,24},{
          -22,24}}, color={0,0,127}));
  connect(h1.h, add1.u1) annotation (Line(points={{-59,50},{-40,50},{-40,36},{-22,
          36}}, color={0,0,127}));
  connect(T1, add2.u1) annotation (Line(points={{-120,50},{-88,50},{-88,-10},{-32,
          -10},{-32,-24},{-22,-24}}, color={0,0,127}));
  connect(T2, add2.u2) annotation (Line(points={{-120,-50},{-88,-50},{-88,-16},{
          -40,-16},{-40,-36},{-22,-36}}, color={0,0,127}));
  connect(add1.y, div.u1)
    annotation (Line(points={{1,30},{20,30},{20,6},{38,6}}, color={0,0,127}));
  connect(add2.y, div.u2) annotation (Line(points={{1,-30},{20,-30},{20,-6},{38,
          -6}}, color={0,0,127}));
  connect(div.y, cpe)
