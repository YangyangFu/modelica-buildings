...
tim_CriAHU100, iGri_CriAHU100 = resCriAHU100.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriAHU100,iGri_CriAHU100, kind='linear')
iGri_CriAHU100 = int(tim_Nor)
...
tim_CriPum100, iGri_CriPum100 = resCriPum100.values("bat.terminal.i[1]")
# interplote to every minute
...
int = interpolate.interp1d(tim_CriPum100,iGri_CriPum100, kind='linear')
iGri_CriPum100 = int(tim_Nor)
...
tim_CriPumAHU100, iGri_CriPumAHU100 = resCriPumAHU100.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriPumAHU100,iGri_CriPumAHU100, kind='linear')
iGri_CriPumAHU100 = int(tim_Nor)
...
tim_CriAHU075, iGri_CriAHU075 = resCriAHU075.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriAHU075,iGri_CriAHU075, kind='linear')
iGri_CriAHU075 = int(tim_Nor)
#**** critical equipment: AHU + Pumps
#*************************
...
tim_CriPum075, iGri_CriPum075 = resCriPum075.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriPum075,iGri_CriPum075, kind='linear')
iGri_CriPum075 = int(tim_Nor)
...
tim_CriPumAHU075, iGri_CriPumAHU075 = resCriPumAHU075.values("bat.terminal.i[1]")
# interplote to every minute
...
int = interpolate.interp1d(tim_CriPumAHU075,iGri_CriPumAHU075, kind='linear')
iGri_CriPumAHU075 = int(tim_Nor)
...
tim_CriAHU050, iGri_CriAHU050 = resCriAHU050.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriAHU050,iGri_CriAHU050, kind='linear')
iGri_CriAHU050 = int(tim_Nor)
#**** critical equipment: AHU + Pumps
#*************************
...
tim_CriPum050, iGri_CriPum050 = resCriPum050.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriPum050,iGri_CriPum050, kind='linear')
iGri_CriPum050 = int(tim_Nor)
...
tim_CriPumAHU050, iGri_CriPumAHU050 = resCriPumAHU050.values("bat.terminal.i[1]")
# interplote to every minute
...
int = interpolate.interp1d(tim_CriPumAHU050,iGri_CriPumAHU050, kind='linear')
iGri_CriPumAHU050 = int(tim_Nor)
...
tim_CriAHU025, iGri_CriAHU025 = resCriAHU025.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriAHU025,iGri_CriAHU025, kind='linear')
iGri_CriAHU025 = int(tim_Nor)
#**** critical equipment: AHU + Pumps
#*************************
...
tim_CriPum025, iGri_CriPum025 = resCriPum025.values("bat.terminal.i[1]")
...
int = interpolate.interp1d(tim_CriPum025,iGri_CriPum025, kind='linear')
iGri_CriPum025 = int(tim_Nor)
...
tim_CriPumAHU025, iGri_CriPumAHU025 = resCriPumAHU025.values("bat.terminal.i[1]")
# interplote to every minute
...
int = interpolate.interp1d(tim_CriPumAHU025,iGri_CriPumAHU025, kind='linear')
iGri_CriPumAHU025 = int(tim_Nor)
...
plt.xlabel('')
plt.grid(True)
plt.legend(["$s_1$","$s_2$","$s_3$"],fontsize=16,ncol=3,bbox_to_anchor=(0., 1.02, 1., .102), loc='lower left', borderaxespad=0.)
...
plt.subplot(313)
plt.plot(timeindex.time,iGri_CriAHU100/1000,color = 'k',linestyle=linestyles[0],marker = 'o',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPum100/1000,color = 'k',linestyle=linestyles[1],marker = '.',markersize=14,alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPumAHU100/1000,color = 'k',linestyle=linestyles[2],marker = 'v',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(2,len(timeindex),18))
...
plt.subplot(313)
plt.plot(timeindex.time,iGri_CriAHU075/1000,color = 'k',linestyle=linestyles[0],marker = 'o',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPum075/1000,color = 'k',linestyle=linestyles[1],marker = '.',markersize=14,alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPumAHU075/1000,color = 'k',linestyle=linestyles[2],marker = 'v',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(2,len(timeindex),18))
plt.ylabel('UPS Current [kA]')
plt.xticks(a,fontsize=16)
plt.grid(True)
...
plt.subplot(313)
plt.plot(timeindex.time,iGri_CriAHU050/1000,color = 'k',linestyle=linestyles[0],marker = 'o',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPum050/1000,color = 'k',linestyle=linestyles[1],marker = '.',markersize=14,alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPumAHU050/1000,color = 'k',linestyle=linestyles[2],marker = 'v',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(2,len(timeindex),18))
plt.ylabel('UPS Current [kA]')
plt.xticks(a,fontsize=16)
plt.grid(True)
...
plt.subplot(313)
plt.plot(timeindex.time,iGri_CriAHU025/1000,color = 'k',linestyle=linestyles[0],marker = 'o',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPum025/1000,color = 'k',linestyle=linestyles[1],marker = '.',markersize=14,alpha=0.8,markevery=range(0,len(timeindex),18))
plt.plot(timeindex.time,iGri_CriPumAHU025/1000,color = 'k',linestyle=linestyles[2],marker = 'v',markersize=12,markeredgecolor = 'k',
         markeredgewidth=1,markerfacecolor="none",alpha=0.8,markevery=range(2,len(timeindex),18))
plt.ylabel('UPS Current [kA]')
plt.xticks(a,fontsize=16)
plt.grid(True)
